...
function diariorumbosur_setup() {
     ...
     * If you're building a theme based on diariorumbosur, use a find and replace
     * to change 'diariorumbosur' to the name of your theme in all the template files
     */
 ...
 *
 */
function diariorumbosur_register_custom_background() {
    $args = array(
        'default-color' => 'e9e0d1',
    );
 
    $args = apply_filters( 'diariorumbosur_custom_background_args', $args );
...
add_action( 'after_setup_theme', 'diariorumbosur_register_custom_background' );
