...
///////////// modificado para diariorumbosur...
    ...
    if ($check=="small"){
      $term_out ="<img src='%actual_icon_href%' alt='' style='float:right;' title='%o_mo_actual% %sunmoon_text%' %o_code_destructor_0%width='30'>%o_actual_temp%";
      if($opt_hide_feels_like!="checked"){
        $term_out=$term_out."<br />ST  %o_actual_windchill%";
      }
